...
public class CandidateBulkEmailVerification {
	WebDriver ldriver;
	WebDriverWait wait;
	JavascriptExecutor js;
	Robot rbt;
	public CandidateBulkEmailVerification(WebDriver rdriver) {
		this.ldriver = rdriver;
		PageFactory.initElements(ldriver, this);
	}

	// Candidate Email Verification
	@FindBy(xpath = "//a[contains(text(),'Pre-Joining Formalities for British Telecom')]")
	@CacheLookup
